...
if (true) {
	...
	NewTab($axure.globalVariableProvider.getLinkUrl('11_2_3_Phi_u_nh_p_kho.html'), "");

}
});
gv_vAlignTable['u5'] = 'center';gv_vAlignTable['u9'] = 'center';gv_vAlignTable['u33'] = 'center';
u67.style.cursor = 'pointer';
$axure.eventManager.click('u67', function(e) {

if (true) {

	NewTab($axure.globalVariableProvider.getLinkUrl('11_2_1_Tim_ki_m_s_n_ph_m_nh_p_kho.html'), "");

}
});
gv_vAlignTable['u47'] = 'center';gv_vAlignTable['u10'] = 'top';gv_vAlignTable['u37'] = 'center';gv_vAlignTable['u29'] = 'center';gv_vAlignTable['u59'] = 'center';