                    ...
                    <table  style="width: 100%;">
                        ...
                        <tr>
                            <td style="width: 150px">
                                Nhóm website (<span style="color: #CC0000">*</span>):
                            </td>
                            <td>
                                <asp:DropDownList ID="ddParrentWebsite" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddCategoryIdParent_SelectedIndexChanged"
                                    CssClass="Cbo">
                                </asp:DropDownList>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td style="width: 123px">
                                Tên website(<span style="color: #CC0000">*</span>):
                            </td>
                            <td>
                                <asp:DropDownList ID="ddWebsiteId" runat="server" CssClass="Cbo" AutoPostBack="True">
                                </asp:DropDownList>
                                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddWebsiteId"
