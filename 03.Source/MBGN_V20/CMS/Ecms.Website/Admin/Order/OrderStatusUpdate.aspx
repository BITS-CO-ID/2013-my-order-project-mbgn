...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <asp:MultiView ActiveViewIndex="0" runat="server" ID="mtvMain">
        <asp:View ID="fromView" runat="server">
            <b>Cập nhật tình trạng giao hàng cho món hàng mua hộ</b>
                ...
                <tr runat="server">
                    ...
                    <td>
                        <asp:DropDownList ID="ddlStatus" runat="server" CssClass="Cbo" >
                            <%--<asp:ListItem Value="1" Text="Đang gom link"></asp:ListItem>
                           ...
                           <%-- <asp:ListItem Value="4" Text="Đã đến Mỹ"></asp:ListItem>
                            ...
                            <asp:ListItem Value="7" Text="Đã giao hàng"></asp:ListItem>
                        </asp:DropDownList>
                    </td>
                </tr>
                <tr runat="server" >
