    ...
    public partial class ChangeDeliveryStatus : PageBase
    {
        ...
        protected void btnAccept_Click(object sender, EventArgs e)
        {
            try
            {
                if (Session["dictChangeStatus"] != null)
                {
					...
					if (_orderService.ChangeDeliveryStatus(orderId, trackingNumber, ddlStatus.SelectedValue, dateStatusText, this.txtRemark.Text, this))
					{
        ...
        private void LoadData()
        {
            if (Session["dictChangeStatus"] != null)
            {
                ...
                var detail = _orderService.OrderDetailModelGet(
                            ""
                            , ""
                            , dictChangeStatus["orderDetailId"].ToString()
                            , ""
                            , ""
                            , ""
                            , ""
                ...
                if (detail != null)
                {
                    txtRemark.Text = detail.FirstOrDefault().Remark;
                }
            }
        }
