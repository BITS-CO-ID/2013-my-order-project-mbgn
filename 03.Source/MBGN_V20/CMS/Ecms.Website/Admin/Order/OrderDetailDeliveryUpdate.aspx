...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <asp:MultiView ActiveViewIndex="0" ID="mtvMain" runat="server">
        <asp:View ID="step2View" runat="server">
            ...
            <div class="btnLine">
                <asp:Button ID="btnAddToCartTransport" runat="server" Text="Thêm vào đơn hàng" OnClick="btnAddToCartTransport_Click"
                    CssClass="button" />
                &nbsp;<asp:Button ID="btnPrevious" runat="server" CssClass="button cancel" OnClick="btnPrevious_Click"
                    Text="Quay lại" />
            </div>
