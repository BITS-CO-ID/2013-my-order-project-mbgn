...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentTitlePlaceHolder" runat="server">
    ...
    <script type="text/javascript">
        window.onload = function () {
            CKEDITOR.replace('<%= txtShortContentCK.ClientID %>', { filebrowserImageUploadUrl: 'News.ashx' });
            CKEDITOR.replace('<%= txtNewsContentCK.ClientID %>', { filebrowserImageUploadUrl: 'News.ashx' });
        };
    </script>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddType" runat="server" CssClass="Cbo" AutoPostBack="True" OnSelectedIndexChanged="ddType_SelectedIndexChanged">
                                    ...
                                    <asp:ListItem Value="4">Hỏi đáp</asp:ListItem>
                                    <asp:ListItem Value="5">Link nhanh</asp:ListItem>
                                    <asp:ListItem Value="6">Tin tức</asp:ListItem>
                                    <asp:ListItem Value="7">Kiến thức mua hàng</asp:ListItem>
                                    <asp:ListItem Value="8">Thông báo</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td>
                                &nbsp;
