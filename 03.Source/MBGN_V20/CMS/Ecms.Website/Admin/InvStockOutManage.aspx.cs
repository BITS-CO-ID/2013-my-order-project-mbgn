...
{
    public partial class InvStockOutManage : PageBase
    {        
        #region //Declares
        ...
        {
            Response.Redirect("~/admin/invstockoutcreate.aspx");
        }
        ...
        protected void gridMain_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "StockInOutDetail":
                    Response.Redirect("~/admin/importstockoutdetail.aspx");
                    break;
            }
        }
        ...
        { 
            try
            {
                ...
                var listResult = _stockService.StockInOutGet(fDate.ToString("yyyy-MM-dd 00:00:00"),
                                                            ...
                                                            txtInOutCode.Text,
                                                            Convert.ToString(StockType.StockOut),
                                                            this.txtCusCode.Text,
                                                            this.Page
                                                            );
