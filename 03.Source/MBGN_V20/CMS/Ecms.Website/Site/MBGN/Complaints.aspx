<%@ Page Title="" Language="C#" MasterPageFile="~/Site/CMS.Master" ValidateRequest="false"
    ...
    <div class="wrap-new complaint">
        <fieldset style="">
                    ...
                    <td>
                        <asp:GridView runat="server" AutoGenerateColumns="False" ID="grdD" CssClass="gridview"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField>
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtEdit" runat="server" CommandArgument='<%#Eval("Id") %>' OnCommand="lbtEdit_Click"
                                            CommandName="Edit">Xem chi tiết</asp:LinkButton>
                                    </ItemTemplate>
            ...
            <table style="width: 100%;" align="center" class="tableForm">
                <tr>
                    <td>
                        <asp:Button ID="btnAddnew" runat="server" CssClass="button" Text="Thêm phản ánh"
                    ...
                    <td>
                        ...
                        <asp:Panel ID="pnAddNew" Visible="False" runat="server" BorderStyle="None">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtTitle"
                                CssClass="validate" ErrorMessage="Không được để trống."></asp:RequiredFieldValidator>
                            <br />
                            <asp:Button ID="btnSave" CssClass="button green" runat="server" Text="Gửi" OnClick="btnSave_Click" />
                            <asp:Button ID="btnCancel" CssClass="button" runat="server" Text="Hủy bỏ" OnClick="btnCancel_Click"
