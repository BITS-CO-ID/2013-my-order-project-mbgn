...
namespace Ecms.Website.Site.MBGN
{
    public partial class Quotation : System.Web.UI.Page
    {
        ...
        protected void btnAccept_Click(object sender, EventArgs e)
        {
			try
			{
				...
				foreach (var item in cartDetailLinks)
				{
					...
					//    & !ddlOrigin1.SelectedValue.Equals("0"))
					//{
					//    var detail = new OrderDetail
					//    {
					//        ProductLink = txtLink1.Text.Trim(),
					//        CountryId = Convert.ToInt32(ddlOrigin1.SelectedValue)
					//    };
					//    order.OrderDetails.Add(detail);
					//}
				}
        ...
        private void InitData()
        {
            ...
            ddlOrigin1.DataBind();
            ddlOrigin1.Items.Insert(0, new ListItem("-- Chọn xuất xứ --", ""));           
        }

        private bool IsValidData()
        {
            //string text1 = txtLink1.Text + (ddlOrigin1.SelectedValue.Equals("0") ? "" : ddlOrigin1.SelectedValue);
