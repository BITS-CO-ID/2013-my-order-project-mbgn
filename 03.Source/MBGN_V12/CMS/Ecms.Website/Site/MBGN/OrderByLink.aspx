            ...
            <table class="tableForm" style="width: 100%;" align="center">
                ...
                <tr>
                    <%--<td class="tdFirst indend">
                        Nhóm website <strong>&nbsp;</strong><span class="required"><strong>*</strong></span>
                    </td>
                    <td>--%>
                        <asp:DropDownList ID="ddlWebsiteGroup" runat="server" AutoPostBack="True"  Visible="false"
                            CssClass="ddlWebsiteGroup" 
                            onselectedindexchanged="ddlWebsiteGroup_SelectedIndexChanged">
                        </asp:DropDownList>
                    <%--</td>--%>
                    <td class="indend">
                    ...
                    <td>
                        <asp:TextBox ID="txtLinkProduct" runat="server" 
                            CssClass="textbox txtLinkProduct"></asp:TextBox>
                    </td>
                    <td class="tdFirst indend">
                ...
                <tr>
                    <%--<td class="indend">
                        Website<strong> </strong><span class="required"><strong>*</strong></span>
                    </td>
                    <td>--%>
                        <asp:DropDownList ID="ddlWebsite" runat="server" CssClass="ddlWebsite" Visible="false">
                        </asp:DropDownList>
                    <%--</td>--%>
                    <td class="indend">
                        Xuất xứ website<strong> </strong><span class="required">*</span>
                    </td>
                    <td>
                        <asp:DropDownList ID="ddlOrigin" runat="server" AutoPostBack="True" 
                            CssClass="ddlOrigin" OnSelectedIndexChanged="ddlOrigin_SelectedIndexChanged">
                        </asp:DropDownList>
                    </td>
                    <td class="indend">
                        Giá web <asp:Label ID="lblCurencyPriceWeb" runat="server" Visible="False"></asp:Label> <span class="required"><strong>*</strong></span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td class="indend">
                        Giá web off <asp:Label ID="lblCurencyPriceWebOff" runat="server" Visible="False"></asp:Label>
                    </td>
                    <td>
