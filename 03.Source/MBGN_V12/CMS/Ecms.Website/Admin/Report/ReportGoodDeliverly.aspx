...
<%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <table style="width:700px;" >
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddWebsiteId" runat="server" AutoPostBack="True" CssClass="Cbo">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
    ...
    <div class="btnLine">
        ...
        <asp:Button ID="btnPrintDeliverly" runat="server" CssClass="button" Text="In phiếu giao nhận" OnClick="btnPrintDeliverly_Click" />
    </div>
    <div>
