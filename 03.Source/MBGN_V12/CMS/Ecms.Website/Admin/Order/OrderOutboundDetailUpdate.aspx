<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="OrderOutboundDetailUpdate.aspx.cs" Inherits="Ecms.Website.Admin.Order.OrderOutboundDetailUpdate" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <asp:MultiView ActiveViewIndex="0" runat="server" ID="mtvMain">
        <asp:View ID="fromView" runat="server">
            ...
            <div class="btnLine">
                <asp:Button ID="btnAccept" runat="server" CssClass="button" Text="Xác nhận" OnClick="btnAccept_Click" OnClientClick="return confirm('Bạn có chắc chắn muốn thay đổi tình trạng món hàng này?');"/>
