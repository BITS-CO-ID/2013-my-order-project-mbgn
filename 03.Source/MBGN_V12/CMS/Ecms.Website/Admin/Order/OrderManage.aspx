...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <table style="width:750px" >
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtCustomerNoDelivery" CssClass="textbox" runat="server"></asp:TextBox>
            </td>
    ...
    <div class="data">
        <asp:GridView ID="gridMain" runat="server" CssClass="gridview" OnPageIndexChanging="gridMain_PageIndexChanging"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="SH khách hàng">
                    <ItemTemplate>
                        <%# Convert.ToInt32(Eval("OrderTypeId").ToString()) == 3 ? Eval("CustomerCodeDelivery") : ""%>
                    </ItemTemplate>
                ...
                <%--<asp:TemplateField HeaderText="Chuyển<br/> thanh toán">
                    <ItemTemplate>
                        <asp:LinkButton Text='Chuyển TT' ID="lbtnPaymentForward" CommandArgument='<%# Eval("OrderId") %>'
                            CommandName="PaymentForward" runat="server" OnCommand="lbtnPaymentForward_Click" />
                    </ItemTemplate>
                    <ItemStyle Width="60" HorizontalAlign="Right" />
                </asp:TemplateField>--%>
                <asp:TemplateField HeaderText="Cập nhật<br/>NVBH">
                    <ItemTemplate>
                        <asp:LinkButton Text='Cập nhật' ID="lbtnEmployee" CommandArgument='<%# Eval("OrderId") %>'
