...
namespace CommonUtils
{
    ...
    {
		public const string CustomerAccount_MBGN = "200300601";
		public const int CustomerIdAccount_MBGN = 222;
	...
	public static class OrderOutboundStatus
	{
		...
		public const string CancelText = "Hủy, thay đổi thông tin";
	...
	public static class Const_BusinessCode
	{
		...
		public const string Business_202_Text = "MBGN Hoàn trả tiền cho khách hàng";

		public const string Business_203 = "203";
		public const string Business_203_Text = "MBGN mua hàng từ đối tác";

		public const string Business_204 = "204";
		public const string Business_204_Text = "MBGN nạp tiền vào tài khoản";
		...
		public const string Business_206_Text = "MBGN Xác nhận đã giao hàng";
    ...
    {
        public const int ServiceType = 0;
        public const int SaleOff = 1;
        //public const int News = 2;
        public const int QAType = 4;
        public const int PopularLinkType = 5;
        public const int News = 6;
        public const int KnowBuy = 7; // Kiến thức mua hàng
        public const int Alert = 8; // Thông báo
    }
