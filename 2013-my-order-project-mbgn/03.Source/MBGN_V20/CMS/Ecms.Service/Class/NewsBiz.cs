    ...
    public class NewsBiz : INews
    {
                        ...
                        else
                        {
                            switch (item.Type)
                            {
                                ...
                                case 4:
                                    ...
                                    break;
                                case 5:
                                    item.gType = "Link nhanh";
                                    break;
                                case 6:
                                    item.gType = "Tin tức";
                                    break;
                                case 7:
                                    item.gType = "Kiến thức mua hàng";
                                    break;
                                case 8:
                                    item.gType = "Thông báo";
                                    break;
                            }
                        }
        ...
        public bool NewsDelete(string newsId, ref string alParamsOutError)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    ...
                    #region // Delete
					_db.News.DeleteObject(deleteNews);
                    _db.SaveChanges();
                    #endregion
                    return true;
                }
        ...
        public News NewsCreate(News news, ref string alParamsOutError)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    news.LastDateModify = DateTime.Now;
                    _db.News.AddObject(news);
                    _db.SaveChanges();
                }
                return news;
            }
        ...
        public News NewsUpdate(News news, ref string alParamsOutError)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    ...
                    ne.LastDateModify = DateTime.Now;
                    _db.SaveChanges();
        ...
        public bool News_CommentDelete(string commentId, ref string alParamsOutError)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    ...
                    _db.News_Comment.DeleteObject(comm);
                    _db.SaveChanges();
                    #endregion
                    return true;
                }
        ...
        public News_Comment News_CommentCreate(News_Comment news_comment, ref string alParamsOutError)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    _db.News_Comment.AddObject(news_comment);
                    _db.SaveChanges();
                }
                return news_comment;
            }
