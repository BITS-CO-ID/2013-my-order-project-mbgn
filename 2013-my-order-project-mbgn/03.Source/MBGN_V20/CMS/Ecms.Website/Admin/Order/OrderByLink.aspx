        ...
        <ContentTemplate>
            <table class="tableForm" style="width: 60%">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlWebsiteGroup" runat="server" AutoPostBack="True" CssClass="cbo" 
                ...
                <tr>
                    ...
                    <td class="indend">
                        Giá web <asp:Label ID="lblCurencyPriceWeb" runat="server" Visible="False"></asp:Label> <span style="color: Red;">*</span>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtPriceWebOff" runat="server" CssClass="textbox"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="indend">
                        Xuất xứ website<span style="color: Red;">*</span>
                    </td>
                    <td>
