    ...
    public partial class GroupLinkCart : PageBase
    {
		...
		protected void btnSave_Click(object sender, EventArgs e)
		{
			try
			{
                ...
                {
                    orderOutbound.OrderNumber = txtOrderNumber.Text;
                }
				...
				{
					//orderOutbound.WebsiteAccountVisaId = Convert.ToInt32(ddlVisa.SelectedValue);
        ...
        private void InitData()
        {
            ...
            {               
				...
				ddlVisa.DataBind();
				ddlVisa.Items.Insert(0, new ListItem("--- Chọn Số Visa ---", ""));	
            }
        }
        ...
        {           
			...
			if (string.IsNullOrEmpty(ddlVisa.SelectedValue))
			{
				lblError.Text = "Bạn chưa chọn số Visa thanh toán !";
				lblError.Visible = true;
				return false;
			}
