    ...
    <asp:MultiView ActiveViewIndex="0" runat="server" ID="mtvMain">
        <asp:View runat="server" ID="formView">
            <table style="width: 50%;">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlStatus" runat="server" CssClass="cbo" AutoPostBack="True"
                            ...
                            <asp:ListItem Value="3">Hủy, thay đổi thông tin</asp:ListItem>
                ...
                <tr>
                    <td>
                        <asp:Label ID="Label1" runat="server" Text="Hướng xử lý"></asp:Label>
                    </td>
                    <td>
                        <asp:TextBox runat="server" ID="txtRemark" CssClass="Textbox" Height="40" Width="200"/>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
            ...
            <div class="btnLine">
                <asp:Button Text="Xác nhận" runat="server" ID="btnAccept" CssClass="button" OnClientClick="return confirm('Bạn có chắc chắn muốn xác nhận?');"
