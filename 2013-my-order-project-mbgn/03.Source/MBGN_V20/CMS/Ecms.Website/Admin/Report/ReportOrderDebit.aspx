    ...
    <div>
        <asp:GridView ID="gridMain" runat="server" AutoGenerateColumns="False" CssClass="gridview"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Tên khách hàng<br>(3)">
                    <ItemTemplate>
                        <%#Eval("CustomerName") %>
                    </ItemTemplate>
                </asp:TemplateField>

                <asp:TemplateField HeaderText="CN đầu kỳ<br>(4)">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Phát sinh trong kỳ<br>(5)">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="CN Cuối kỳ<br>(6)=(4)+(5)">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Đã TT Cuối kỳ<br>(7)">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Tổng tiền<br/>vận chuyển cuối kỳ<br>(8)">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Tổng tiền tính phí<br/>trả chậm cuối kỳ<br>(9)">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="CN Còn lại<br>(11)=(6)+(10)-(7)">
                    <ItemTemplate>
