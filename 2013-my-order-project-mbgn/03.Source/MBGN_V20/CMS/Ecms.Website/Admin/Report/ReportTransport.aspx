<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="ReportTransport.aspx.cs" Inherits="Ecms.Website.Admin.Report.ReportTransport" %>

<%@ Register Assembly="obout_Calendar2_Net" Namespace="OboutInc.Calendar2" TagPrefix="obout" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentTitlePlaceHolder" runat="server">
    Báo cáo tổng hợp đơn hàng vận chuyển
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <table style="width:800px;" >
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" ID="txtGHFromDate" CssClass="datepicker" />
                <obout:Calendar ID="cldDeliveryFromDate" runat="server" DatePickerMode="true" CultureName="vi-VN"
                    YearMonthFormat="dd/MM/yyyy" TextBoxId="txtGHFromDate" Columns="1" DatePickerImageTooltip="Chọn ngày"
                    DatePickerImagePath="../../Content/Images/icons/Calender-icon.png" MultiSelectedDates="True" DatePickerSynchronize="true">
                </obout:Calendar>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox runat="server" ID="txtGHToDate" CssClass="datepicker" />
                <obout:Calendar ID="cldDeliveryToDate" runat="server" DatePickerMode="true" CultureName="vi-VN"
                    YearMonthFormat="dd/MM/yyyy" TextBoxId="txtGHToDate" Columns="1" DatePickerImageTooltip="Chọn ngày"
                    DatePickerImagePath="../../Content/Images/icons/Calender-icon.png" DatePickerSynchronize="true">
                </obout:Calendar>
        ...
        <asp:GridView ID="gridMain" runat="server" AutoGenerateColumns="False" CssClass="gridview"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Trọng lượng(kg)">
                    <ItemTemplate>
                        <%#Convert.ToDouble((Eval("SumWeight")??0)).ToString("N2")%>
                    </ItemTemplate>
                    <FooterTemplate>
                    <strong>
                        <%#rptSumWeight.ToString("N2")%>
                    </strong>
                    </FooterTemplate>
