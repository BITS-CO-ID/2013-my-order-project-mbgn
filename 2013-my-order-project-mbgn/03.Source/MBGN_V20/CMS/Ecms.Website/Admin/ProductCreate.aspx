    ...
    <div class="content-box">
        ...
        <div class="content-box-content">
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlStockStatus" runat="server" CssClass="Cbo" Visible="false">
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBox ID="ChkDeadOfDay" runat="server" Checked="false"/>
                    </td>
                    <td>
                        Phí vận chuyển:
                    </td>
                    <td>
                        <asp:TextBox ID="txtFeeShip" runat="server" CssClass="doubleNumber textbox" Font-Bold="true" Font-Size="Medium"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td colspan="3">
                        <asp:TextBox ID="txtShipComment" runat="server" TextMode="MultiLine" Height="60px" Width="450px"
