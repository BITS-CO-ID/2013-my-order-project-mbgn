<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="InvStockOutManage.aspx.cs" Inherits="Ecms.Website.Admin.InvStockOutManage" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    ...
    <div class="btnLine">
        ...
        &nbsp;<asp:Button ID="btnCreate" runat="server" Text="Tạo Phiếu xuất" 
    ...
    <div class="data">
        &nbsp;<asp:GridView ID="gridMain" runat="server" CssClass="gridview" 
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Mã phiếu xuất">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Ngày xuất">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Người xuất">
                    <ItemTemplate>
                        <%# Eval("StatusText") %>
                    </ItemTemplate>
                </asp:TemplateField>
