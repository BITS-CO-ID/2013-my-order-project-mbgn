...
namespace Ecms.Website.Common
{
	public class Utils
	{
        ...
        public static string RecoverUrlName(string strVNurlName)
        {
            if (string.IsNullOrEmpty(strVNurlName)) return "";

            string url = "";
            url = CommonUtils.StringUtils.StringVN2StringEN(strVNurlName);
