...
<p class="p-note">QUẢN LÝ ĐƠN HÀNG</p>
    ...
    <asp:Panel runat="server" ID="pnOrderEmpty">
        <div style="color: Red; padding-bottom:25px;">
            Không có đơn hàng nào theo thông tin tìm kiếm!
        </div>
    </asp:Panel>
    <asp:Panel runat="server" ID="pnCartNotEmty">
        <div style="float: left; margin-top: 10px; margin-bottom: 25px;">
            <asp:GridView ID="gridCart" runat="server" AutoGenerateColumns="False" CssClass="gridview"
                ...
                OnRowDataBound="gridMain_RowDataBound" ShowFooter="true">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Công nợ ĐH<br/>(11)=(6)-(7)+(10)">
                        <ItemTemplate>
