...
namespace Ecms.Website.DBServices
{
    public class CustomerService : BaseService
    {
        ...
        public Customer CustomerRegister(string userName, string password, string fullName, string mobile, string email, string address, string province, Page page)
        {
            try
            {
                ...
                if (returnCustomer != null)
                {
                    ...
                    strBuilder.Append("<br />Chúc mừng Quý khách đã đăng ký thành công tài khoản trên <a href='http://muabangiaonhan.com'>muabangiaonhan.com</a><br />.");
                    ...
                    strBuilder.Append("Với tài khoản này, Quý khách có thể sử dụng các dịch vụ trên <a href='http://muabangiaonhan.com'>muabangiaonhan.com</a><br /><br />");
                    ...
                    CommonUtils.SendmailHelper.SendInfo(strContent, "Đăng ký tài khoản - MUABANGIAONHAN.COM", returnCustomer.Email);
                }
        ...
        public CustomerTemp CustomerTempCreate(CustomerTemp customertemp, Page page)
        {
            try
            {
                string alParamsOutError = "";
                var result = this._customerBiz.CustomerTempCreate(customertemp, ref alParamsOutError);
                if (!string.IsNullOrEmpty(alParamsOutError))
                    throw GenServiceException(alParamsOutError);
                return result;
            }
