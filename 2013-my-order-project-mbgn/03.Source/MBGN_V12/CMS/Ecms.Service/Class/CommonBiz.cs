    ...
    public class CommonBiz : ICommonBiz
    {
        ...
        public void DeleteCompany(string companyId)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    ...
                    _db.Companies.DeleteObject(company);
                    _db.SaveChanges();
                    #endregion
                }
            }
        ...
        public void AddCompany(Company company)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    _db.Companies.AddObject(company);
                    _db.SaveChanges();
                }
            }
            catch (Exception ex)
		...
		public bool DeleteVisaAccount(string visaId)
		{
			...
			try
			{
				using (var _db = new EcmsEntities())
				{
					...
					_db.Mst_VisaAccount.DeleteObject(visa);
					_db.SaveChanges();
					return true;
					#endregion
				}
		...
		public Mst_VisaAccount AddVisaAccount(Mst_VisaAccount visaObj)
		{
			...
			try
			{
				using (var _db = new EcmsEntities())
				{
					_db.Mst_VisaAccount.AddObject(visaObj);
					_db.SaveChanges();
					return visaObj;
				}
			}
