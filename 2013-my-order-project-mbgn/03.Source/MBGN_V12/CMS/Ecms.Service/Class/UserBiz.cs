                ...
                , out string alParamsOutError)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    ...
                    _db.Sys_User.DeleteObject(user);
                    _db.SaveChanges();
                    #endregion
                }
            }
        ...
        public void DeleteGroup(string groupCode)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    ...
                    _db.Sys_Group.DeleteObject(Group);
                    _db.SaveChanges();
                }
            }
            catch (Exception ex)
        ...
        public void Remove(string objectCode)
        {
            ...
            try
            {
                using (var _db = new EcmsEntities())
                {
                    ...
                    _db.Sys_Object.DeleteObject(Object);
                    _db.SaveChanges();
                }
            }
            catch (Exception ex)
            ...
            try
            {
                using (var ts = new TransactionScope())
                {
                    using (var _db = new EcmsEntities())
                    {
                        ...
                        {
                            _db.Sys_MapGroupObject.AddObject(item);
                        }
                        _db.SaveChanges();
                    }
                    ts.Complete();
            ...
            try
            {
                using (var ts = new TransactionScope())
                {
                    using (var _db = new EcmsEntities())
                    {
                        ...
                        {
                            _db.Sys_MapGroupObject.DeleteObject(item);
                        }
                        #endregion
            ...
            try
            {
                using (var ts = new TransactionScope())
                {
                    using (var _db = new EcmsEntities())
                    {
                        ...
                        {
                            _db.Sys_MapUserGroup.AddObject(item);
                        }
                        _db.SaveChanges();
                    }
                    ts.Complete();
            ...
            try
            {
                using (var ts = new TransactionScope())
                {
                    using (var _db = new EcmsEntities())
                    {
                        ...
                        foreach (var item in mapGObj)
                        {
                            _db.Sys_MapUserGroup.DeleteObject(item);
                        }
                        #endregion
