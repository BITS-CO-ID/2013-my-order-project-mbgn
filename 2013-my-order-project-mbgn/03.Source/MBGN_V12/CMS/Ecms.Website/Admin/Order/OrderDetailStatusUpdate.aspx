        ...
        <asp:GridView ID="gridMain" runat="server" AutoGenerateColumns="False" CssClass="gridview"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Mã<br/>món hàng">
                     <ItemTemplate>
                        <%--<asp:Label ID="lblDetailCode" runat="server" Text='<%# Eval("DetailCode") %>' ></asp:Label>--%>
                        <div class="tag">
                                ...
                                <div id="tooltip" style="display: none;">
                                    <table>
                                        ...
                                        <tr>
                                            <td style="white-space: nowrap;"><b>Ngày đến Mỹ:</b>&nbsp;</td>
                                            <td><%# Eval("DateToUsa") == null ? "" : Convert.ToDateTime(Eval("DateToUsa")).ToString("dd/MM/yyyy")%></td>
                                        </tr>
                                        <tr>
                ...
                <%--<asp:TemplateField HeaderText="Tên KH">
                 ...
                 <asp:TemplateField HeaderText="Tên<br/>sản phẩm">
                    <ItemTemplate>
                        <%#Eval("ProductName")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Số<br/>lượng">
                        ...
                        <asp:TemplateField HeaderText="Giá<br/>khai<br/>báo">
                            <ItemTemplate>
               ...
               <%-- <asp:TemplateField HeaderText="Ngày<br/>về Mỹ">
                    <ItemTemplate>
                        <%# Eval("DateToUsa") == null ? "" : Convert.ToDateTime(Eval("DateToUsa")).ToString("dd/MM/yyyy")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Cập nhật<br/>TT<br/>món hàng">
                   <ItemTemplate>
                 ...
                 <asp:TemplateField HeaderText="Tình trạng<br/>món hàng">
                            <ItemTemplate>
                                <asp:LinkButton Text='<%# Eval("DetailStatusText") %>' 
                                    Enabled='<%# Eval("OrderTypeId").ToString().Equals("3")? Eval("DetailStatus").ToString().Equals("6") ? false: true: Eval("DetailStatus").ToString().Equals("5") ? true: false %>'
